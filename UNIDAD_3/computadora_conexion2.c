...
void conectar() {
 ...
 if (mysql_real_connect(con, "localhost", "root", "12345", "computadora2", 
...
// Relación Uno a Muchos: Accesorios
...
// Relación Muchos a Muchos: Usuarios y Computadoras
...
// Mostrar todas las computadoras con sus usuarios
